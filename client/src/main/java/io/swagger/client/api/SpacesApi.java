...
public class SpacesApi {
     ...
     * @param q Full text search value (optional, default to *)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSpacesCall(String assignedId, String q, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSpacesValidateBeforeCall(String assignedId, String q, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getSpacesCall(assignedId, q, offset, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GenericDataRepresentationListSpaceData getSpaces(String assignedId, String q, Integer offset, Integer limit) throws ApiException {
        ApiResponse<GenericDataRepresentationListSpaceData> resp = getSpacesWithHttpInfo(assignedId, q, offset, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GenericDataRepresentationListSpaceData> getSpacesWithHttpInfo(String assignedId, String q, Integer offset, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = getSpacesValidateBeforeCall(assignedId, q, offset, limit, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getSpacesAsync(String assignedId, String q, Integer offset, Integer limit, final ApiCallback<GenericDataRepresentationListSpaceData> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSpacesValidateBeforeCall(assignedId, q, offset, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GenericDataRepresentationListSpaceData>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
