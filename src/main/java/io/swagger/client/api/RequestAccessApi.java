...
public class RequestAccessApi {
     ...
     */
    public com.squareup.okhttp.Call getRequestAccessCall(List<String> space, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getRequestAccessValidateBeforeCall(List<String> space, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getRequestAccessCall(space, status, progressListener, progressRequestListener);
        return call;
     ...
     */
    public GenericDataRepresentationListRequestData getRequestAccess(List<String> space, String status) throws ApiException {
        ApiResponse<GenericDataRepresentationListRequestData> resp = getRequestAccessWithHttpInfo(space, status);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GenericDataRepresentationListRequestData> getRequestAccessWithHttpInfo(List<String> space, String status) throws ApiException {
        com.squareup.okhttp.Call call = getRequestAccessValidateBeforeCall(space, status, null, null);
     ...
     */
    public com.squareup.okhttp.Call getRequestAccessAsync(List<String> space, String status, final ApiCallback<GenericDataRepresentationListRequestData> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getRequestAccessValidateBeforeCall(space, status, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GenericDataRepresentationListRequestData>(){}.getType();
